...
def download():
  ...
  API_URL = "https://backend.metacritic.com/finder/metacritic/web?sortBy=-releaseDate&productType=games&page=1&offset={offset}&limit=50"
...
def parse(downloaded_data):
  ...
  results_list = sorted(results, key=lambda x: (results[x]["name"].lower(), int(results[x]["P12078"])))
...
if __name__ == "__main__":
  ...
  results = download()
  with open("results/Metacritic.json", "w", -1, "utf-8") as writer:
